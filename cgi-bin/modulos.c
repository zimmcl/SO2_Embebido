 ...
 * @brief Muestra las opciones para la instalación y desinstalacuón de módulos en el kernel.
 * 		  A su vez lista la totalidad de módulos actualmente cargados.
 * 		  Para la instalación de un módulo hace uso de rutina upload.pl, pasando como argumentos
 * 		  las credenciales y el módulo a ser instalado.
 * 		  Para la desinstalación de un módulo hace uso de rutina remove.pl, pasando como argumentos
 * 		  las credenciales y el módulo a ser desinstalado.
 * @version 0.1
 * @date 2020-02-12
 * 
...
int main(int argc, char *argv[])
{
	...
	printf("<TITLE>TP3 - Modulos</TITLE>\n");
	...
	printf("<H2 align=center><tt>GESTION DE MODULOS \n</tt></H2></font>");
	printf("<hr>");
	...
	printf("<p>Modulo a cargar: <input type=file name=modulo accept=.ko style=font-size:12pt;height:25px;width:175px/></p> ");
	...
	printf("<font size='5' color='white' >El servidor acepta archivos con extension '.ko'</font></div></div>");
